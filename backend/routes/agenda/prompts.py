from routes.agenda.model import Agenda
...
Outcome goals - Add 2-3 clear objectives to aim for in the meeting (e.g., securing a pilot project, scheduling follow-up with technical team)
