...
Attachments (if provided, incorporate relevant information from them into the agenda)
...
If participants are provided, give succinct and relevant insights into each participant's potential priorities and concerns based on their professional roles. If no participants are provided, suggest appropriate participants to invite and assign them to specific agenda items. You have ability to websearch informations about participants via function call.
...
IMPORTANT: If attachments are provided in the context field (marked with "Attachments provided for reference"), carefully review the content of these attachments and incorporate relevant information from them into your agenda. Mention specific points from the attachments in the checklist items, highlight key information that should be discussed during the meeting, and add relevant preparation tips based on the attachment content. This helps create a more informed and contextually relevant agenda.
"""
